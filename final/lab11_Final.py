...
def keyboard(self, key):
    ...
    if key == ord('1'):
        ...
        self.move_up(80)
        #whole track
        self.move_forward(140)
        self.move_up(70)
        self.move_forward(110)
        self.move_down(180)
        self.move_forward(240)
        self.move_up(85)
...
def main():
    ...
    # if drone.get_battery() > 20:  # Ensure the battery level is sufficient
    #         try:
    #             drone.move_up(50)
    ...
    while True:
        ...
        # Load predefined ArUco marker dictionary
        ...
        if len(markerCorners) > 0:
            ...
            for i in range(rvec.shape[0]):
                ...
                frame = cv2.drawFrameAxes(frame, intri, distortion, rvec[i,:,:], tvec[i,:,:], 10)
                cv2.putText(frame,
        ...
        if len(markerCorners) > 0:
            for i in range(rvec.shape[0]):
                ...
                # Start from here
                if progress == 4 and landdirectrion == 0:
                    progress = 5
                    image = letterbox(frame, (640, 640), stride=64, auto=True)[0]
